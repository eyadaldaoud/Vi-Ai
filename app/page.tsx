...
import { BsArrowDown, BsSend } from "react-icons/bs";
...
export default function Home() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hello! I'm your AI assistant powered by OpenAI's GPT model. How can I help you today?",
    },
  ]);
  ...
  const generateResponse = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        "An error occurred while generating the response. Please check your API key and try again."
      );
      console.error(err);
    } finally {
      setLoading(false);
            ...
            <div className="relative">
              ...
              >
                {loading ? (
                  ...
                  >
                    <BsArrowDown className="text-white w-4 h-4" />
                  </motion.div>
                ) : (
